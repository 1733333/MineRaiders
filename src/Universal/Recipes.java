...
public enum Recipes {
        ...
        for (int row = 0; row < shape.length; row++) {
            ...
            for (int col = 0; col < line.length(); col++) {
                ...
                if (choice instanceof RecipeChoice.MaterialChoice mc) {
                    stacks = mc.getChoices().stream()
                            .map(ItemStack::new)
                            .toArray(ItemStack[]::new);
                } else if (choice instanceof RecipeChoice.ExactChoice ec) {
                    stacks = ec.getChoices().toArray(new ItemStack[0]);
                }

                if (stacks != null && stacks.length > 0) {
                    flat[index] = stacks[0].clone();
                } else {
                    flat[index] = null;
                }
            }
    ...
    public void r40() {
        ...
        recipeKeys.put(item.getItemMeta().getDisplayName(), key);
        key += 1;
        try{
            Bukkit.addRecipe(r); 
        }
    ...
    public void r109() {
        ...
        r.addIngredient(3,Material.COPPER_NUGGET);
        recipeKeys.put(i.getItemMeta().getDisplayName(), key);
        key += 1;
        try{
            Bukkit.addRecipe(r); 
    ...
    public void r110() {
        ...
        ShapelessRecipe r = new ShapelessRecipe(w,i);
        r.addIngredient(Material.EGG);
        r.addIngredient(3,Material.IRON_NUGGET);
        recipeKeys.put(i.getItemMeta().getDisplayName(), key);
        key += 1;
        try{
            Bukkit.addRecipe(r); 
    ...
    public void r111() {
        ...
        ShapelessRecipe r = new ShapelessRecipe(w,i);
        r.addIngredient(Material.EGG);
        r.addIngredient(3,Material.GOLD_NUGGET);
        recipeKeys.put(i.getItemMeta().getDisplayName(), key);
        key += 1;
        try{
            Bukkit.addRecipe(r); 
    ...
    public void r112() {
        ItemStack i = gp.diamondBattery().clone();
        i.setAmount(4);
        NamespacedKey w = new NamespacedKey(plugin, "r" + key);
        ShapelessRecipe r = new ShapelessRecipe(w,i);
        r.addIngredient(Material.DIAMOND);
        r.addIngredient(4,Material.EGG);
        recipeKeys.put(i.getItemMeta().getDisplayName(), key);
        key += 1;
        try{
            Bukkit.addRecipe(r); 
    ...
    public void r113() {
        ...
        NamespacedKey w = new NamespacedKey(plugin, "r" + key);
        ShapelessRecipe r = new ShapelessRecipe(w,i);
        r.addIngredient(Material.NETHERITE_SCRAP);
        r.addIngredient(8,Material.EGG);
        recipeKeys.put(i.getItemMeta().getDisplayName(), key);
        key += 1;
        try{
            Bukkit.addRecipe(r); 
